/*Programa desarrollado por Brian Steve Rodas Hernandez
	Carnet: RH18031
		Hacer una clase que permita almacenar la informacion de los pacientes en un consultorio
			los datos a almacenar son: Correlativo, nombre, apellido, edad, sexo, peso,
				enfermedad cronica. Tambien la clase debe permitir mostrar la informacion del
					paciente y pedir la informacion del paciente. Crear dos objetos de la clase
						paciente.*/
