/*Programa desarrollado por Brian Steve Rodas Hernandez
	Carnet: RH18031
		Ejecricio hacer un guardado de coordenadas de un vector, sacar los promedios de cada uno.
			Utilizar clases para resolver el problema*/
...
void menu() { //Funcion para mostrar menu
	system("cls"); //Borrar pantalla de la consola
	system("color 6F"); //Cambiar colores, fondo moztaza, texto blanco
